...
def test_gscale_ms2(command):
    result = kx132acr_lbz.test_gscale(command, 'z', 'ms2_match', tolerance=1)
    result = kx132acr_lbz.test_gscale(command, 'y', 'ms2_match', append_results=True, tolerance=1)
    result = kx132acr_lbz.test_gscale(command, 'x', 'ms2_match', append_results=True, tolerance=1)
