...
factory_linux_local_test = util.BuildFactory()
###### PROJECTS
...
projects['linux_local_test']={
    'name': 'linux_local_test',
    'branches': ['kernel'],
    'repo_git': 'https://github.com/RohmSemiconductor/Linux-Driver-Testing-Local.git',
    'polling': 20,
    'treeStableTimer': 30,
    'scheduler_name': 'scheduler-local-test',
    'builderNames': ["linux-local-test"],
    'workerNames': ["Linux_Worker"],
    'factory': factory_linux_local_test,
}
